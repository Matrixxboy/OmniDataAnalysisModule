-- ============================================================
-- SAMPLE DATABASE SETUP — Module 2: SQL & Databases
-- Run this script first before practising any queries
-- Compatible with: PostgreSQL | MySQL | DB Fiddle
-- ============================================================
...
(18,1014, 102, 1,  1200.00) -- Note: customer 4 has a mix
;
...
(3, 'Engineering', 'Pune'),
(4, 'HR',          'Delhi'),
(5, 'Finance',     'Chennai');  -- No employees in Finance (useful for JOIN practice)
